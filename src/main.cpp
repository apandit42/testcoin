...
uint256 hashGenesisBlock("0x8e73c640857b8c68fb99651ce7cca353f01c7639ef3983dafc389c0f2c09ebcc");
...
static const int64 nTargetTimespan = 4 * 60; // Testcoin: 4 minutes
static const int64 nTargetSpacing = 1 * 60; // Testcoin: 1 minute
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8e73c640857b8c68fb99651ce7cca353f01c7639ef3983dafc389c0f2c09ebcc");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "TrumpTrumpDisDatBoi";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("696984710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1495321231;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1012040;
        ...
        assert(block.hashMerkleRoot == uint256("0xa50bba14c693104b9e5e2855aa68bc67fcdfa74c9db8d2e883b1e384272f774e"));
